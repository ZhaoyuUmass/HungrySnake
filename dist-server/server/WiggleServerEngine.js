  ...
  function (_ServerEngine) {
    ...
    _createClass(WiggleServerEngine, [{
      ...
      value: function onPlayerConnected(socket) {
        ...
        /// fadhil-start - additional
        this.currentPlayerId = socket.playerId;
        /// fadhil-end - additional
      }
    }, {
      ...
      value: function wiggleEatFood(w, f) {
        ...
        w.bodyLength++;
        /// fadhil-start - additional
        if (w.playerId == this.currentPlayerId) {
          console.log(">>> ", w.playerId, w.bodyLength);
          // storing to file 
          fs.writeFile('state.txt', "" + w.playerId + " " + w.bodyLength, err => {
            if (err) {
              console.log("failed to store state:", err);
            }
          })
        }
        /// fadhil-end - additional
